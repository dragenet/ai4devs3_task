...
<objective>
Your task is to answer the question and return a JSON object containing the answer in the text field using as few words as possible and THE SAME msgId as string.
</objective>
...
Q: {"msgId": 456, "text": "What is the famous number from Hitchhiker's Guide to the Galaxy?"}
A: {"text": "69", "msgId": 456}

Q: {"msgId": 789, "text": "What year is it currently?"}
A: {"text": "1999", "msgId": 789}
